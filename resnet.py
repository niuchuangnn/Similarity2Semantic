...
class ClusterResNet(ResNetTrunk):
  def __init__(self, num_classes, in_channels=3, in_size=96, batchnorm_track=True, test=False):
...
class ResConvEncoder(ResNetTrunk):
  def __init__(self, in_channels=3, batchnorm_track=True):
